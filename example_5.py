...
for i in range(100): # repeat 100 times
  ...
  if (random_led == 0):   tree.leds_on_and_wait(L0, 0.1) # D0 on for 0.2s
  elif (random_led == 1): tree.leds_on_and_wait(L1, 0.1) # D1 on for 0.2s
  elif (random_led == 2): tree.leds_on_and_wait(L2, 0.1) # D2 on for 0.2s
  elif (random_led == 3): tree.leds_on_and_wait(L3, 0.1) # D3 on for 0.2s
  elif (random_led == 4): tree.leds_on_and_wait(L4, 0.1) # D4 on for 0.2s
  elif (random_led == 5): tree.leds_on_and_wait(L5, 0.1) # D5 on for 0.2s
  elif (random_led == 6): tree.leds_on_and_wait(L6, 0.1) # D6 on for 0.2s
